        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!pwd.equals(cnfPwd)) {
                    Toast.makeText(RegistrationActivity.this,"Confirm Password does not match with Entered Password",Toast.LENGTH_SHORT).show();
                }
                else if(TextUtils.isEmpty(userName)&& TextUtils.isEmpty(pwd) && TextUtils.isEmpty(cnfPwd)){
                    Toast.makeText(RegistrationActivity.this,"Please enter all information..",Toast.LENGTH_SHORT).show();
                }
                else{
